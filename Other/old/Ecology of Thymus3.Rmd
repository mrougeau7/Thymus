...
for(i in 1:length(txtfiles)){
  ...
  #I want to store all the counts. I need them to correspond to their original file name though.I also need to be able to refer to certain sections. 
...
spe.kmeans <- kmeans(input, centers=cluster, nstart=10)
  
  }

# define vectors to store results (mean sortable silt values)
#will fix this later results = data.frame(txtfiles, means)
print(results)
