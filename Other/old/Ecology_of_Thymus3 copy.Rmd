...
#KNITR gets confused with this read.table call. chunk compiles on its own though? and individual calls work fine. 
...
spe_3.3=read.table("spe.kmeans3_Thymus1Mutant_K4_100_Sec3.csv", head=T, sep=",")
