...
Authors :Mary Browning, John Wares, Nancy Manley
...
setwd("~/Dropbox/R scripts/Datasets/Data with 11 cell types/Mutant1")

Count1<-read.table("~/Dropbox/Mary's R scripts/Datasets/Data with 11 cell types/WT1/CD11c_1.txt",header=T,sep="\t",fill=TRUE)
Count2<-read.table("~/Dropbox/Mary's R scripts/Datasets/Data with 11 cell types/WT1/CD11c_2.txt",header=T,sep="\t",fill=TRUE)
Count3<-read.table("~/Dropbox/Mary's R scripts/Datasets/Data with 11 cell types/WT1/CD11c_3.txt",header=T,sep="\t",fill=TRUE)
Count4<-read.table("~/Dropbox/Mary's R scripts/Datasets/Data with 11 cell types/WT1/CD25_1.txt",header=T,sep="\t",fill=TRUE)
Count5<-read.table("~/Dropbox/Mary's R scripts/Datasets/Data with 11 cell types/WT1/CD25_2.txt",header=T,sep="\t",fill=TRUE)
Count6<-read.table("~/Dropbox/Mary's R scripts/Datasets/Data with 11 cell types/WT1/CD25_3.txt",header=T,sep="\t",fill=TRUE)
Count7<-read.table("~/Dropbox/Mary's R scripts/Datasets/Data with 11 cell types/WT1/CD31_1.txt",header=T,sep="\t",fill=TRUE)
Count8<-read.table("~/Dropbox/Mary's R scripts/Datasets/Data with 11 cell types/WT1/CD31_2.txt",header=T,sep="\t",fill=TRUE)
Count9<-read.table("~/Dropbox/Mary's R scripts/Datasets/Data with 11 cell types/WT1/CD31_3.txt",header=T,sep="\t",fill=TRUE)
Count10<-read.table("~/Dropbox/Mary's R scripts/Datasets/Data with 11 cell types/WT1/CD205_1.txt",header=T,sep="\t",fill=TRUE)
Count11<-read.table("~/Dropbox/Mary's R scripts/Datasets/Data with 11 cell types/WT1/CD205_2.txt",header=T,sep="\t",fill=TRUE)
Count12<-read.table("~/Dropbox/Mary's R scripts/Datasets/Data with 11 cell types/WT1/CD205_3.txt",header=T,sep="\t",fill=TRUE)
Count13<-read.table("~/Dropbox/Mary's R scripts/Datasets/Data with 11 cell types/WT1/Claud5_1.txt",header=T,sep="\t",fill=TRUE)
Count14<-read.table("~/Dropbox/Mary's R scripts/Datasets/Data with 11 cell types/WT1/Claud5_2.txt",header=T,sep="\t",fill=TRUE)
Count15<-read.table("~/Dropbox/Mary's R scripts/Datasets/Data with 11 cell types/WT1/Claud5_3.txt",header=T,sep="\t",fill=TRUE)
Count16<-read.table("~/Dropbox/Mary's R scripts/Datasets/Data with 11 cell types/WT1/Claud34_1.txt",header=T,sep="\t",fill=TRUE)
Count17<-read.table("~/Dropbox/Mary's R scripts/Datasets/Data with 11 cell types/WT1/Claud34_2.txt",header=T,sep="\t",fill=TRUE)
Count18<-read.table("~/Dropbox/Mary's R scripts/Datasets/Data with 11 cell types/WT1/Claud34_3.txt",header=T,sep="\t",fill=TRUE)
Count19<-read.table("~/Dropbox/Mary's R scripts/Datasets/Data with 11 cell types/WT1/Foxp3_1.txt",header=T,sep="\t",fill=TRUE)
Count20<-read.table("~/Dropbox/Mary's R scripts/Datasets/Data with 11 cell types/WT1/Foxp3_2.txt",header=T,sep="\t",fill=TRUE)
Count21<-read.table("~/Dropbox/Mary's R scripts/Datasets/Data with 11 cell types/WT1/Foxp3_3.txt",header=T,sep="\t",fill=TRUE)
Count22<-read.table("~/Dropbox/Mary's R scripts/Datasets/Data with 11 cell types/WT1/K5_1.txt",header=T,sep="\t",fill=TRUE)
Count23<-read.table("~/Dropbox/Mary's R scripts/Datasets/Data with 11 cell types/WT1/K5_2.txt",header=T,sep="\t",fill=TRUE)
Count24<-read.table("~/Dropbox/Mary's R scripts/Datasets/Data with 11 cell types/WT1/K5_3.txt",header=T,sep="\t",fill=TRUE)
Count25<-read.table("~/Dropbox/Mary's R scripts/Datasets/Data with 11 cell types/WT1/K14_1.txt",header=T,sep="\t",fill=TRUE)
Count26<-read.table("~/Dropbox/Mary's R scripts/Datasets/Data with 11 cell types/WT1/K14_2.txt",header=T,sep="\t",fill=TRUE)
Count27<-read.table("~/Dropbox/Mary's R scripts/Datasets/Data with 11 cell types/WT1/K14_3.txt",header=T,sep="\t",fill=TRUE)
Count28<-read.table("~/Dropbox/Mary's R scripts/Datasets/Data with 11 cell types/WT1/PDGFRb_1.txt",header=T,sep="\t",fill=TRUE)
Count29<-read.table("~/Dropbox/Mary's R scripts/Datasets/Data with 11 cell types/WT1/PDGFRb_2.txt",header=T,sep="\t",fill=TRUE)
Count30<-read.table("~/Dropbox/Mary's R scripts/Datasets/Data with 11 cell types/WT1/PDGFRb_3.txt",header=T,sep="\t",fill=TRUE)
Count31<-read.table("~/Dropbox/Mary's R scripts/Datasets/Data with 11 cell types/WT1/UEA1_1.txt",header=T,sep="\t",fill=TRUE)
Count32<-read.table("~/Dropbox/Mary's R scripts/Datasets/Data with 11 cell types/WT1/UEA1_2.txt",header=T,sep="\t",fill=TRUE)
Count33<-read.table("~/Dropbox/Mary's R scripts/Datasets/Data with 11 cell types/WT1/UEA1_3.txt",header=T,sep="\t",fill=TRUE)
...
```{r Mutant1-11 cell types} 

Count1.2<-read.table("~/Dropbox/Mary's R scripts/Datasets/Data with 11 cell types/Mutant1/CD11c_1_mutant.txt",header=T,sep="\t",fill=TRUE)
Count2.2<-read.table("~/Dropbox/Mary's R scripts/Datasets/Data with 11 cell types/Mutant1/CD11c_2_mutant.txt",header=T,sep="\t",fill=TRUE)
Count3.2<-read.table("~/Dropbox/Mary's R scripts/Datasets/Data with 11 cell types/Mutant1/CD11c_4_mutant.txt",header=T,sep="\t",fill=TRUE)
Count4.2<-read.table("~/Dropbox/Mary's R scripts/Datasets/Data with 11 cell types/Mutant1/CD25_2_mutant.txt",header=T,sep="\t",fill=TRUE)
Count5.2<-read.table("~/Dropbox/Mary's R scripts/Datasets/Data with 11 cell types/Mutant1/CD25_3_mutant.txt",header=T,sep="\t",fill=TRUE)
Count6.2<-read.table("~/Dropbox/Mary's R scripts/Datasets/Data with 11 cell types/Mutant1/CD25_4_mutant.txt",header=T,sep="\t",fill=TRUE)
Count7.2<-read.table("~/Dropbox/Mary's R scripts/Datasets/Data with 11 cell types/Mutant1/CD31_2_mutant.txt",header=T,sep="\t",fill=TRUE)
Count8.2<-read.table("~/Dropbox/Mary's R scripts/Datasets/Data with 11 cell types/Mutant1/CD31_3_mutant.txt",header=T,sep="\t",fill=TRUE)
Count9.2<-read.table("~/Dropbox/Mary's R scripts/Datasets/Data with 11 cell types/Mutant1/CD31_4_mutant.txt",header=T,sep="\t",fill=TRUE)
Count10.2<-read.table("~/Dropbox/Mary's R scripts/Datasets/Data with 11 cell types/Mutant1/CD205_1_mutant.txt",header=T,sep="\t",fill=TRUE)
Count11.2<-read.table("~/Dropbox/Mary's R scripts/Datasets/Data with 11 cell types/Mutant1/CD205_2_mutant.txt",header=T,sep="\t",fill=TRUE)
Count12.2<-read.table("~/Dropbox/Mary's R scripts/Datasets/Data with 11 cell types/Mutant1/CD205_4_mutant.txt",header=T,sep="\t",fill=TRUE)
Count13.2<-read.table("~/Dropbox/Mary's R scripts/Datasets/Data with 11 cell types/Mutant1/Claud5_2_mutant.txt",header=T,sep="\t",fill=TRUE)
Count14.2<-read.table("~/Dropbox/Mary's R scripts/Datasets/Data with 11 cell types/Mutant1/Claud5_4_mutant.txt",header=T,sep="\t",fill=TRUE)
Count15.2<-read.table("~/Dropbox/Mary's R scripts/Datasets/Data with 11 cell types/Mutant1/Claud5_5_mutant.txt",header=T,sep="\t",fill=TRUE)
Count16.2<-read.table("~/Dropbox/Mary's R scripts/Datasets/Data with 11 cell types/Mutant1/Claud34_2_mutant.txt",header=T,sep="\t",fill=TRUE)
Count17.2<-read.table("~/Dropbox/Mary's R scripts/Datasets/Data with 11 cell types/Mutant1/Claud34_3_mutant.txt",header=T,sep="\t",fill=TRUE)
Count18.2<-read.table("~/Dropbox/Mary's R scripts/Datasets/Data with 11 cell types/Mutant1/Claud34_4_mutant.txt",header=T,sep="\t",fill=TRUE)
Count19.2<-read.table("~/Dropbox/Mary's R scripts/Datasets/Data with 11 cell types/Mutant1/Foxp3_2_mutant.txt",header=T,sep="\t",fill=TRUE)
Count20.2<-read.table("~/Dropbox/Mary's R scripts/Datasets/Data with 11 cell types/Mutant1/Foxp3_4_mutant.txt",header=T,sep="\t",fill=TRUE)
Count21.2<-read.table("~/Dropbox/Mary's R scripts/Datasets/Data with 11 cell types/Mutant1/Foxp3_5_mutant.txt",header=T,sep="\t",fill=TRUE)
Count22.2<-read.table("~/Dropbox/Mary's R scripts/Datasets/Data with 11 cell types/Mutant1/K5_2_mutant.txt",header=T,sep="\t",fill=TRUE)
Count23.2<-read.table("~/Dropbox/Mary's R scripts/Datasets/Data with 11 cell types/Mutant1/K5_4_mutant.txt",header=T,sep="\t",fill=TRUE)
Count24.2<-read.table("~/Dropbox/Mary's R scripts/Datasets/Data with 11 cell types/Mutant1/K5_5_mutant.txt",header=T,sep="\t",fill=TRUE)
Count25.2<-read.table("~/Dropbox/Mary's R scripts/Datasets/Data with 11 cell types/Mutant1/K14_2_mutant.txt",header=T,sep="\t",fill=TRUE)
Count26.2<-read.table("~/Dropbox/Mary's R scripts/Datasets/Data with 11 cell types/Mutant1/K14_4_mutant.txt",header=T,sep="\t",fill=TRUE)
Count27.2<-read.table("~/Dropbox/Mary's R scripts/Datasets/Data with 11 cell types/Mutant1/K14_5_mutant.txt",header=T,sep="\t",fill=TRUE)
Count28.2<-read.table("~/Dropbox/Mary's R scripts/Datasets/Data with 11 cell types/Mutant1/PDGFRb_1_mutant.txt",header=T,sep="\t",fill=TRUE)
Count29.2<-read.table("~/Dropbox/Mary's R scripts/Datasets/Data with 11 cell types/Mutant1/PDGFRb_2_mutant.txt",header=T,sep="\t",fill=TRUE)
Count30.2<-read.table("~/Dropbox/Mary's R scripts/Datasets/Data with 11 cell types/Mutant1/PDGFRb_4_mutant.txt",header=T,sep="\t",fill=TRUE)
Count31.2<-read.table("~/Dropbox/Mary's R scripts/Datasets/Data with 11 cell types/Mutant1/UEA1_2_mutant.txt",header=T,sep="\t",fill=TRUE)
Count32.2<-read.table("~/Dropbox/Mary's R scripts/Datasets/Data with 11 cell types/Mutant1/UEA1_3_mutant.txt",header=T,sep="\t",fill=TRUE)
Count33.2<-read.table("~/Dropbox/Mary's R scripts/Datasets/Data with 11 cell types/Mutant1/UEA1_4_mutant.txt",header=T,sep="\t",fill=TRUE)
...
```{r Mutant2-11 cell types}
#Mutant2
Count1.3<-read.table("~/Dropbox/Mary's R scripts/Datasets/Data with 11 cell types/Mutant2/CD11c_mutant2_2.txt",header=T,sep="\t",fill=TRUE)
Count2.3<-read.table("~/Dropbox/Mary's R scripts/Datasets/Data with 11 cell types/Mutant2/CD11c_mutant2_3.txt",header=T,sep="\t",fill=TRUE)
Count3.3<-read.table("~/Dropbox/Mary's R scripts/Datasets/Data with 11 cell types/Mutant2/CD11c_mutant2_4.txt",header=T,sep="\t",fill=TRUE)
Count4.3<-read.table("~/Dropbox/Mary's R scripts/Datasets/Data with 11 cell types/Mutant2/CD25_mutant2_1.txt",header=T,sep="\t",fill=TRUE)
Count5.3<-read.table("~/Dropbox/Mary's R scripts/Datasets/Data with 11 cell types/Mutant2/CD25_mutant2_2.txt",header=T,sep="\t",fill=TRUE)
Count6.3<-read.table("~/Dropbox/Mary's R scripts/Datasets/Data with 11 cell types/Mutant2/CD25_mutant2_3.txt",header=T,sep="\t",fill=TRUE)
Count7.3<-read.table("~/Dropbox/Mary's R scripts/Datasets/Data with 11 cell types/Mutant2/CD31_mutant2_1.txt",header=T,sep="\t",fill=TRUE)
Count8.3<-read.table("~/Dropbox/Mary's R scripts/Datasets/Data with 11 cell types/Mutant2/CD31_mutant2_2.txt",header=T,sep="\t",fill=TRUE)
Count9.3<-read.table("~/Dropbox/Mary's R scripts/Datasets/Data with 11 cell types/Mutant2/CD31_mutant2_3.txt",header=T,sep="\t",fill=TRUE)
Count10.3<-read.table("~/Dropbox/Mary's R scripts/Datasets/Data with 11 cell types/Mutant2/CD205_mutant2_2.txt",header=T,sep="\t",fill=TRUE)
Count11.3<-read.table("~/Dropbox/Mary's R scripts/Datasets/Data with 11 cell types/Mutant2/CD205_mutant2_3.txt",header=T,sep="\t",fill=TRUE)
Count12.3<-read.table("~/Dropbox/Mary's R scripts/Datasets/Data with 11 cell types/Mutant2/CD205_mutant2_4.txt",header=T,sep="\t",fill=TRUE)
Count13.3<-read.table("~/Dropbox/Mary's R scripts/Datasets/Data with 11 cell types/Mutant2/Claud5_mutant2_2.txt",header=T,sep="\t",fill=TRUE)
Count14.3<-read.table("~/Dropbox/Mary's R scripts/Datasets/Data with 11 cell types/Mutant2/Claud5_mutant2_3.txt",header=T,sep="\t",fill=TRUE)
Count15.3<-read.table("~/Dropbox/Mary's R scripts/Datasets/Data with 11 cell types/Mutant2/Claud5_mutant2_4.txt",header=T,sep="\t",fill=TRUE)
Count16.3<-read.table("~/Dropbox/Mary's R scripts/Datasets/Data with 11 cell types/Mutant2/Claud34_mutant2_1.txt",header=T,sep="\t",fill=TRUE)
Count17.3<-read.table("~/Dropbox/Mary's R scripts/Datasets/Data with 11 cell types/Mutant2/Claud34_mutant2_2.txt",header=T,sep="\t",fill=TRUE)
Count18.3<-read.table("~/Dropbox/Mary's R scripts/Datasets/Data with 11 cell types/Mutant2/Claud34_mutant2_3.txt",header=T,sep="\t",fill=TRUE)
Count19.3<-read.table("~/Dropbox/Mary's R scripts/Datasets/Data with 11 cell types/Mutant2/Foxp3_mutant2_2.txt",header=T,sep="\t",fill=TRUE)
Count20.3<-read.table("~/Dropbox/Mary's R scripts/Datasets/Data with 11 cell types/Mutant2/Foxp3_mutant2_3.txt",header=T,sep="\t",fill=TRUE)
Count21.3<-read.table("~/Dropbox/Mary's R scripts/Datasets/Data with 11 cell types/Mutant2/Foxp3_mutant2_4.txt",header=T,sep="\t",fill=TRUE)
Count22.3<-read.table("~/Dropbox/Mary's R scripts/Datasets/Data with 11 cell types/Mutant2/K5_mutant2_2.txt",header=T,sep="\t",fill=TRUE)
Count23.3<-read.table("~/Dropbox/Mary's R scripts/Datasets/Data with 11 cell types/Mutant2/K5_mutant2_3.txt",header=T,sep="\t",fill=TRUE)
Count24.3<-read.table("~/Dropbox/Mary's R scripts/Datasets/Data with 11 cell types/Mutant2/K5_mutant2_4.txt",header=T,sep="\t",fill=TRUE)
Count25.3<-read.table("~/Dropbox/Mary's R scripts/Datasets/Data with 11 cell types/Mutant2/K14_mutant2_2.txt",header=T,sep="\t",fill=TRUE)
Count26.3<-read.table("~/Dropbox/Mary's R scripts/Datasets/Data with 11 cell types/Mutant2/K14_mutant2_3.txt",header=T,sep="\t",fill=TRUE)
Count27.3<-read.table("~/Dropbox/Mary's R scripts/Datasets/Data with 11 cell types/Mutant2/K14_mutant2_4.txt",header=T,sep="\t",fill=TRUE)
Count28.3<-read.table("~/Dropbox/Mary's R scripts/Datasets/Data with 11 cell types/Mutant2/PDGFRb_mutant2_2.txt",header=T,sep="\t",fill=TRUE)
Count29.3<-read.table("~/Dropbox/Mary's R scripts/Datasets/Data with 11 cell types/Mutant2/PDGFRb_mutant2_3.txt",header=T,sep="\t",fill=TRUE)
Count30.3<-read.table("~/Dropbox/Mary's R scripts/Datasets/Data with 11 cell types/Mutant2/PDGFRb_mutant2_4.txt",header=T,sep="\t",fill=TRUE)
Count31.3<-read.table("~/Dropbox/Mary's R scripts/Datasets/Data with 11 cell types/Mutant2/UEA1_mutant2_1.txt",header=T,sep="\t",fill=TRUE)
Count32.3<-read.table("~/Dropbox/Mary's R scripts/Datasets/Data with 11 cell types/Mutant2/UEA1_mutant2_2.txt",header=T,sep="\t",fill=TRUE)
Count33.3<-read.table("~/Dropbox/Mary's R scripts/Datasets/Data with 11 cell types/Mutant2/UEA1_mutant2_3.txt",header=T,sep="\t",fill=TRUE)
...
spe.kmeans3 <- kmeans(spe3, centers=4, nstart=1000)
spe.kmeans3.1 <- kmeans(spe3.1, centers=4, nstart=100)
spe.kmeans3.2 <- kmeans(spe3.2, centers=4, nstart=100)
spe.kmeans3.2 <- kmeans(spe3.2, centers=4, nstart=100)
...
write.table(spe.kmeans1.2$cluster, file="spe.kmeans_Thymus1WT_K4_100_Sec3.csv", sep=",")
...
write.table(spe.kmeans2.2$cluster, file="spe.kmeans2_Thymus1Mutant_K4_100_Sec3.csv", sep=",")
...
write.table(spe.kmeans3.2$cluster, file="spe.kmeans3_Thymus2Mutant_K4_100_Sec3.csv", sep=",")
...
spe_1.2=read.table("spe.kmeans_Thymus1WT_K4_100_Sec3.csv", head=T, sep=",")
...
spe_2.2=read.table("spe.kmeans2_Thymus1Mutant_K4_100_Sec3.csv", head=T, sep=",")

spe_3=read.table("spe.kmeans3_Thymus2Mutant_K4_100.csv", head=T, sep=",")
spe_3.1=read.table("spe.kmeans3_Thymus1Mutant_K4_100_Sec1.csv", head=T, sep=",")
spe_3.2=read.table("spe.kmeans3_Thymus1Mutant_K4_100_Sec2.csv", head=T, sep=",")
spe_3.2=read.table("spe.kmeans3_Thymus1Mutant_K4_100_Sec3.csv", head=T, sep=",")
