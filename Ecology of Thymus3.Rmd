...
```{r WT1-11 cell types, echo=FALSE, warning=FALSE, message=FALSE, results='hide'}   
...
```{r Mutant1-11 cell types, echo=FALSE, warning=FALSE, message=FALSE, results='hide'} 
...
```{r Mutant2-11 cell types, echo=FALSE, warning=FALSE, message=FALSE, results='hide'}
#Mutant2
...
# this may be good opportunity for flexible SHINY output until we settle on what ultimately goes into paper. each plot should get name and you determine when/where they come out, not all of them!
...
```{r panels, echo=FALSE, warning=FALSE, message=FALSE, results='hide'}
...
```{r counts, echo=FALSE, warning=FALSE, message=FALSE, results='hide'}
...
```{r normalize, echo=FALSE, warning=FALSE, message=FALSE, results='hide'}
b2<-b2/sum(b2)
b3<-b3/sum(b3)
b4<-b4/sum(b4)
...
```{r braycurtis, message=FALSE, comment=""}
