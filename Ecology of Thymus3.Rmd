...
Mice
C57BL/6 male mice at 5-6 weeks of age were purchased from Jackson Laboratories (Bar Harbor, Maine). Aire knockout (N=2) and WT male (N=2) mice at 5-6 weeks of age were obtained from Dr. Mark Anderson's lab at the University of California, San Francisco. N=2 for WT and mutant mice.

Isolation and preparation of dissected thymii
...
#data <- lapply(dir(),read.table)  #This is similar to line 120
#head(data[1])
...
for(i in 1:length(txtfiles)){
  ...
  X=tmp[[1]]
  Y=tmp[[2]]
  my.xy1<-hist2d(X,Y,nbins=c(msz,msz))
