...
In order to quantitatively evaluate the organization of the thymus, K means clustering was performed using cell type location and abundance. K values of 3 to - were selected based on previously identified information. For K=2, the cortex and medullary regions were reproduced.  Increasing K to 3 resulted in subdividing of the medullary region. What is driving the clustering?  Dendritic cells found in CMJ? Removal of cell types? 

##Bray Curtis Dissimilarity Index Identifies BLAH
